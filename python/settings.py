...
llista_informes = [["Informe Usuari = \'admin\'", 'DC=problemeszero,DC=com', 'SUBTREE', ['lastlogon', 'userAccountControl', 'samaccountname', 'whenchanged', 'whenCreated'],
 ...
 [ "Usuaris que pertanyen al grup 'Expedients'", 'DC=problemeszero,DC=com', 'SUBTREE',
                    ...
                    ['Usuaris amb darrer logon abans de 2016-06-09', 'DC=problemeszero,DC=com', 'SUBTREE',
                              ...
                              '(&(objectClass=*)(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com)(lastlogon<={f1}))'.format(f1=convertir_data(2016, 6, 9, 20, 40)), False],
                    ['Usuaris no caduca contrasenya', 'DC=problemeszero,DC=com', 'SUBTREE',
                              [ 'cn', 'givenname', 'sn', 'memberOf', 'whenCreated', 'lastlogon', 'userAccountControl'],
                              '(&(objectClass=*)(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com){f1}{f2})'.format(f1=uac_and_mask('ADS_UF_DONT_EXPIRE_PASSWD'), f2=uac_or_mask('ADS_UF_ACCOUNTDISABLE')), False],
                    ...
                    ['Usuaris creats despres de 2017-01-01 i ADS_UF_PASSWD_NOTREQD', 'DC=problemeszero,DC=com', 'SUBTREE',
                              ...
                              '(&(objectClass=*)(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com)(whenCreated>={f1}){f2}{f3})'.format(f1=convertir_data_ISO('2017', '01', '01'), f2=uac_and_mask('ADS_UF_PASSWD_NOTREQD'), f3=uac_or_mask('ADS_UF_ACCOUNTDISABLE')), False],
                    ['Usuaris creats despres de 2019-01-20 i no flag ADS_UF_PASSWD_NOTREQD ', 'DC=problemeszero,DC=com', 'SUBTREE',
                              ['cn', 'givenname', 'sn', 'userAccountControl', 'memberOf', 'whenCreated', 'lastlogon', 'pwdlastset'],
                              '(&(objectClass=*)(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com)(whenCreated>={f1}){f2}{f3})'.format(f1=convertir_data_ISO('2019', '01', '20'), f2=uac_or_mask('ADS_UF_ACCOUNTDISABLE'), f3=uac_or_mask('ADS_UF_PASSWD_NOTREQD')), False],
                    ['Usuaris creats despres de 2019-01-20', 'DC=problemeszero,DC=com', 'SUBTREE',
                              ['cn', 'givenname', 'sn', 'userAccountControl', 'memberOf', 'whenCreated', 'lastlogon', 'pwdlastset'],
                              '(&(objectClass=*)(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com)(whenCreated>={f1}))'.format(f1=convertir_data_ISO('2019', '01', '20')), False],
                    ['Usuaris deshabilitats des de 2019-01-20', 'DC=problemeszero,DC=com', 'SUBTREE',
                              ['cn', 'givenname', 'sn', 'userAccountControl', 'memberOf', 'whenCreated', 'lastlogon', 'pwdlastset'],
                              '(&(objectClass=*)(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com)(whenChanged>={f1}){f2})'.format(f1=convertir_data_ISO('2019', '01', '20'), f2=uac_and_mask('ADS_UF_ACCOUNTDISABLE')), False],
                    ['Usuaris modificats fa mes de 30 dies i no deshabilitats', 'DC=problemeszero,DC=com', 'SUBTREE',
                              ...
                              '(&(objectClass=*) (objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com)(whenChanged<={f1}) {f2})'.format(f1=restar_dies_data_actual_ISO(30), f2=uac_or_mask('ADS_UF_ACCOUNTDISABLE')), False],
                    ['Usuaris amb NOTREQD no deshabilitats', 'DC=problemeszero,DC=com', 'SUBTREE',
                              ...
                              '(&(objectClass=*)(objectCategory=CN=Person,CN=Schema,CN=Configuration,DC=problemeszero,DC=com){f1}{f2})'.format(f1=uac_and_mask('ADS_UF_PASSWD_NOTREQD'), f2=uac_or_mask('ADS_UF_ACCOUNTDISABLE')), False],
